...
#ifdef WIN32
    if((nx_pcap_fp = pcap_open(nx_pcap_source_name, 65536, PCAP_OPENFLAG_PROMISCUOUS, 1, NULL, NULL)) == NULL)
#else
    if((nx_pcap_fp = pcap_open_live(nx_pcap_source_name, 65536, 1, 0, NULL)) == NULL)
#endif
    {
